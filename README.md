...
[9월]
1. [월간 코드 챌린지 시즌1] Level 1: 두 개 뽑아서 더하기
2. [월간 코드 챌린지 시즌1] Level 2: 삼각 달팽이
3. [월간 코드 챌린지 시즌1] Level 3: 풍선 터트리기
4. [월간 코드 챌린지 시즌1] Level 4: 짝수 행 세기

[10월]
5. [월간 코드 챌린지 시즌1] Level 1: 3진법 뒤집기
6. [월간 코드 챌린지 시즌1] Level 2: 쿼드압축 후 개수 세기
7. [월간 코드 챌린지 시즌1] Level 4: 트리 트리오 중간값
8. [월간 코드 챌린지 시즌1] Level 5: 문자열의 아름다움

[11월]
9. [월간 코드 챌린지 시즌1] Level 1: 내적
10. [월간 코드 챌린지 시즌1] Level 2: 이진 변환 반복하기
11. [월간 코드 챌린지 시즌1] Level 3: 스타 수열
12. [월간 코드 챌린지 시즌1] Level 5: 가짜 해밀토니안
